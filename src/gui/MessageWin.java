...
public class MessageWin extends Stage
{
	...
	public MessageWin(int n)
	{
		...
		root.setBackground(new Background(new BackgroundImage(new Image(url), BackgroundRepeat.NO_REPEAT,
	...
	public void circleAnimation()
	{
		...
		circle.setOnMouseClicked(e ->
		{
			...
			if (Data.order == 1 || Data.order == 4 || Data.order == 9)
			{
				new GameWin();
			} else if (Data.order == 2 || Data.order == 5 || Data.order == 10)
			{
				new GameWin1();
			} else if (Data.order == 3 || Data.order == 6 || Data.order == 11)
			{
				new GameWin2();
			} else
			{
