...
public class WarnWin extends Stage
{
	...
	public WarnWin(boolean isSuccessful)
	{
		...
		{
			root.setBackground(
					new Background(new BackgroundImage(new Image("gui/img/success.png"), BackgroundRepeat.NO_REPEAT,
							BackgroundRepeat.NO_REPEAT, BackgroundPosition.CENTER, BackgroundSize.DEFAULT)));
		} else
		{
			root.setBackground(
					new Background(new BackgroundImage(new Image("gui/img/failure.png"), BackgroundRepeat.NO_REPEAT,
							BackgroundRepeat.NO_REPEAT, BackgroundPosition.CENTER, BackgroundSize.DEFAULT)));
		}
