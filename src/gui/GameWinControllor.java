...
public class GameWinControllor
{
	...
	public Button magic;
	@FXML
	public GridPane blockGridPan;
	@FXML
	public AnchorPane root;
	@FXML
	public TextField noticeText;
	...
	void initialize()
	{
		...
		{
			noticeText
					.setText("Your score:" + String.valueOf(score.intValue()) + "    Target score:" + Data.targetScore);
		...
		{
			noticeText.setText("Your score:" + String.valueOf(score.intValue()) + "    Stars:"
					+ String.valueOf(score.intValue() / 1000));
			stepLabel.setLayoutX(980);
		...
		btn.setOnMouseClicked(e ->
		{
			if (isMoving == false)
			{
						...
						{ // 点的两个块相邻
							...
							{ // 消掉全部相同颜色的
								...
								transition.setOnFinished(e2 ->
								{
									...
									// if(BlockManager.twoBlocks.get(0).getColor().equals("MagicBird")){
									// color =
									// BlockManager.twoBlocks.get(1).getColor();
				...
				case "Magic":
					...
					if (Data.mode == 2)
					{
						noticeText.setText("Your score:" + String.valueOf(score.intValue()) + "    Coins:"
								+ String.valueOf(score.intValue() / 1000));
		...
		for (int i = 0; i < BlockManager.length; i++)
		{
			...
			if (Data.mode == 2)
			{
				...
				block.setBackground(new Background(
						new BackgroundImage(new Image("gui/img/star/little.png"), BackgroundRepeat.NO_REPEAT,
