...
public class FileManager
{
	...
	{ CHAPTER1, CHAPTER2, CHAPTER3, CHAPTER4, CHAPTER5, CHAPTER6, CHAPTER7, CHAPTER8, CHAPTER9, CHAPTER10, CHAPTER11,
			CHAPTER12, ENDING1, ENDING2, ENDING3 };

	// private static final String[] chapterNames = {"第一章 遇见未知", "第二章 星座物语",
	// "第三章 遇见未知", "第四章 奇怪的梦", "第五章 神木之约", "第六章 神魔之井", "第七章 迷宫初识", "第八章 生死之门",
	// "第九章 三世回眸",
	...
	public FileManager(int index)
	{
		...
		try
		{
			BufferedReader reader = new BufferedReader(new FileReader(new File(chapters[index - 1])));
