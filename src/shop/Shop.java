...
public class Shop
{
...

	{
		...
		try
		{
			BufferedReader br = new BufferedReader(new FileReader("src/shop/coins.txt"));
	...
	public static void setCoinsCondition()
	{
		try
		{
			BufferedWriter bw = new BufferedWriter(new FileWriter("src/shop/coins.txt", false));
	...
	public static void setPack1Condition()
	{
		try
		{
			BufferedWriter bw = new BufferedWriter(new FileWriter("src/shop/pack1.txt", false));
	...
	public static void setPack2Condition()
	{
		try
		{
			BufferedWriter bw = new BufferedWriter(new FileWriter("src/shop/pack2.txt", false));
	...
	public static void setPack3Condition()
	{
		try
		{
			BufferedWriter bw = new BufferedWriter(new FileWriter("src/shop/pack3.txt", false));
...

	{
		...
		try
		{
			BufferedReader br = new BufferedReader(new FileReader("src/shop/pack1.txt"));
...

	{
		...
		try
		{
			BufferedReader br = new BufferedReader(new FileReader("src/shop/pack2.txt"));
...

	{
		...
		try
		{
			BufferedReader br = new BufferedReader(new FileReader("src/shop/pack3.txt"));
