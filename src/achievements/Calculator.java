...
public class Calculator
{
	...
	public static void getCalculatorCondition()
	{
		...
		try
		{
			BufferedReader br = new BufferedReader(new FileReader("src/achievements/calculator.txt"));
	...
	public static void setCalculatorCondition()
	{
		try
		{
			BufferedWriter bw = new BufferedWriter(new FileWriter("src/achievements/calculator.txt", false));
